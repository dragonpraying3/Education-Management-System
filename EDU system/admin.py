                ...
                while True:
                    try:
                        ...
                        if 1 <= num <= len(accounts):
                            ...
                            part = input("Please enter the part of the account to edit(Role/Username/Password):").title()
                            if part not in account:
                                print("The part you enter is not found in the account page. Please enter again.\n")
                                continue
        ...
        while True:
            try:
                ...
                if 1 <= num <= len(students):
                    ...
                    part = input("Please enter the part of the student to update:").title()
                    if part not in student:
                        print("The part you enter is not found in the student details. Please enter again.\n")
                        continue
...
def update_academic_performance():
    ...
    while True:
        ...
        try:
            ...
            if 1 <= num <= len(grades):
                grade= grades[num - 1]  # get the selected event dictionary from list
                gpa=float(grade['GPA'])
                if gpa == 4.0:
                    performance="A+"
                elif gpa >= 3.7:
...
def create_course():
    ...
    while True:
        ...
        exists=False
        for course in courses:
            if course_id==course['Course ID'] or course_name==course['Course Name'] or instructor==course['Instructor']:
                print(f"The course {course_id} is already exists with instructor {course['Instructor']}.Please create again")
                exists=True
                break
        if not exists:
    ...
    while True:
        ...
        try:
            ...
            if 1 <= num <= len(courses):
                ...
                part = input("Please enter the part of the course to update:").strip()
    ...
    while True:
        ...
        try:
            ...
            if 1 <= num <= len(schedule):
                ...
                item[part] = edition  # change the part to edition entered
