...
def Grade_and_Assessment_Menu():
    while True:
        ...
        print("------------------------------------------------------")
        print("1. Generate Assignment score")
        print("2. Generate Exam score ")
        print("3. Generate GPA")
        print("4. Generate feedback")
        print("5. Exit")
        print("------------------------------------------------------")
